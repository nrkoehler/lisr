...
#> $ EINHEIT    <lgl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, ...
#> $ JAHR_2000  <int> 493208, 237986, 255222, 466069, 219912, 246157, 27139, 1...
#> $ JAHR_2001  <int> 493052, 238175, 254877, 463959, 219207, 244752, 29093, 1...
#> $ JAHR_2002  <int> 494795, 239154, 255641, 463717, 219377, 244340, 31078, 1...
#> $ JAHR_2003  <int> 497531, 240878, 256653, 465230, 220637, 244593, 32301, 2...
#> $ JAHR_2004  <int> 498491, 240818, 257673, 467644, 222198, 245446, 30847, 1...
#> $ JAHR_2005  <int> 502651, 243125, 259526, 470903, 224174, 246729, 31748, 1...
#> $ JAHR_2006  <int> 506578, 245017, 261561, 474597, 226368, 248229, 31981, 1...
#> $ JAHR_2007  <int> 510512, 247282, 263230, 477724, 228329, 249395, 32788, 1...
#> $ JAHR_2008  <int> 515469, 250018, 265451, 481941, 230729, 251212, 33528, 1...
#> $ JAHR_2009  <int> 518862, 251748, 267114, 486564, 233397, 253167, 32298, 1...
#> $ JAHR_2010  <int> 522883, 253533, 269350, 492686, 236809, 255877, 30197, 1...
#> $ JAHR_2011  <int> 510043, 245137, 264906, 487244, 232954, 254290, 22799, 1...
#> $ JAHR_2012  <int> 520838, 251491, 269347, 495062, 237401, 257661, 25776, 1...
#> $ JAHR_2013  <int> 531562, 257445, 274117, 502719, 241647, 261072, 28843, 1...
#> $ JAHR_2014  <int> 544479, 264914, 279565, 511069, 246416, 264653, 33410, 1...
#> $ JAHR_2015  <int> 560472, 274414, 286058, 518473, 250522, 267951, 41999, 2...
#> $ JAHR_2016  <int> 571088, 280292, 290796, 523565, 253236, 270329, 47523, 2...
#> $ JAHR_2017  <int> 581980, 285777, 296203, 529804, 256245, 273559, 52176, 2...
#> $ JAHR_2018  <int> 587857, 288553, 299304, 533218, 257964, 275254, 54639, 3...
#> $ JAHR_2019  <int> 593145, 291450, 301695, 535813, 259368, 276445, 57332, 3...
df$KENNZIFFER
...
#> Rows: 10
#> Columns: 20
#> $ KENNZIFFER <chr> "Haushalte insgesamt", "1-Personen-Haushalte", "2-Person...
#> $ EINHEIT    <chr> "Median in Euro pro m²", "Median in Euro pro m²", "Media...
...
#> $ JAHR_2012  <dbl> 5.145161, 5.145161, 5.172414, 5.000000, 4.687500, 7.2000...
#> $ JAHR_2013  <dbl> 5.075000, 5.034483, 5.147059, 5.072464, 5.150000, 7.2289...
#> $ JAHR_2014  <dbl> 5.384615, 5.454241, 5.238831, 5.313516, 5.344841, 7.4468...
#> $ JAHR_2015  <dbl> 5.294117, 5.244824, 5.333333, 5.488810, 5.326422, 7.5000...
#> $ JAHR_2016  <dbl> 5.390000, 5.333333, 5.407605, 5.600999, 5.399330, 7.5900...
#> $ JAHR_2017  <dbl> 5.620000, 5.563269, 5.622829, 5.631813, 5.891208, 7.7700...
#> $ JAHR_2018  <dbl> 5.875000, 5.833333, 5.938923, 5.961625, 6.187846, 8.2085...
#> $ JAHR_2019  <dbl> 6.029364, 6.000000, 6.034483, 6.641187, 6.260099, 8.1818...
df$KENNZIFFER
...
#> Rows: 18
#> Columns: 21
#> $ KENNZIFFER <chr> "Lufttemperatur (Jahresmittel)", "Abweichung der Lufttem...
#> $ JAHR_2000  <dbl> 10.6, 1.8, 34.8, -12.5, 9.0, 36.0, 7.0, 46.0, 1771.0, 18...
#> $ JAHR_2001  <dbl> 9.5, 0.7, 34.7, -11.5, 6.0, 35.0, 14.0, 84.0, 1576.0, 5....
#> $ JAHR_2002  <dbl> 9.8, 0.9, 34.0, -13.3, 8.0, 44.0, 17.0, 75.0, 1579.0, 5....
#> $ JAHR_2003  <dbl> 9.7, 0.8, 36.0, -20.5, 21.0, 65.0, 25.0, 107.0, 2086.0, ...
#> $ JAHR_2004  <dbl> 9.4, 0.6, 30.3, -15.9, 1.0, 30.0, 12.0, 93.0, 1676.0, 12...
#> $ JAHR_2005  <dbl> 9.6, 0.8, 32.4, -11.7, 6.0, 45.0, 23.0, 89.0, 1823.0, 22...
#> $ JAHR_2006  <dbl> 10.2, 1.4, 36.3, -15.3, 18.0, 60.0, 26.0, 83.0, 1899.0, ...
#> $ JAHR_2007  <dbl> 10.5, 1.7, 36.5, -9.1, 6.0, 44.0, 10.0, 52.0, 1827.0, 22...
#> $ JAHR_2008  <dbl> 10.4, 1.6, 33.4, -8.9, 11.0, 41.0, 8.0, 63.0, 1691.0, 13...
#> $ JAHR_2009  <dbl> 9.8, 1.0, 33.4, -21.8, 5.0, 45.0, 25.0, 78.0, 1735.0, 16...
#> $ JAHR_2010  <dbl> 8.3, -0.5, 36.3, -16.4, 10.0, 39.0, 62.0, 106.0, 1686.0,...
#> $ JAHR_2011  <dbl> 10.3, 1.5, 32.6, -13.4, 3.0, 44.0, 15.0, 73.0, 2043.0, 3...
#> $ JAHR_2012  <dbl> 9.9, 1.1, 37.2, -21.5, 10.0, 44.0, 25.0, 68.0, 1784.0, 1...
#> $ JAHR_2013  <dbl> 9.3, 0.5, 35.4, -15.3, 11.0, 41.0, 31.0, 95.0, 1573.0, 5...
#> $ JAHR_2014  <dbl> 11.0, 2.2, 34.2, -12.2, 8.0, 37.0, 13.0, 48.0, 1780.0, 1...
#> $ JAHR_2015  <dbl> 10.8, 2.0, 37.0, -6.0, 21.0, 49.0, 4.0, 65.0, 1934.0, 29...
#> $ JAHR_2016  <dbl> 10.4, 1.6, 35.4, -11.8, 15.0, 61.0, 9.0, 72.0, 1828.0, 2...
#> $ JAHR_2017  <dbl> 10.3, 1.5, 33.3, -10.8, 9.0, 47.0, 14.0, 117.0, 1722.0, ...
#> $ JAHR_2018  <dbl> 11.30000, 2.50000, 36.60000, -13.20000, 29.00000, 56.000...
#> $ JAHR_2019  <dbl> 11.2000, 2.5000, 38.3000, -9.9000, 25.0000, 42.0000, 6.0...
df$KENNZIFFER
